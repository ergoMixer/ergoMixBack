...
class TokenContractsSpec extends AnyPropSpec with Matchers with ScalaCheckDrivenPropertyChecks with HttpClientTesting {
  ...
  property("AliceEntering") {
    ...
    ergoClient.execute { ctx: BlockchainContext =>
      ...
      val tx = ctx
        .newTxBuilder()
        .addInputs(tokenBox, spendableBox)
  ...
  property("BobEntering") {
    ...
    ergoClient.execute { ctx: BlockchainContext =>
      ...
      val tx = ctx
        .newTxBuilder()
        .addInputs(halfBox, spendableBox, tokenBox)
  ...
  property("RemixAsBob") {
    ...
    ergoClient.execute { ctx: BlockchainContext =>
      ...
      val fullBox = ctx
        ...
        .value(poolValue)
        .registers(
          ErgoValue.of(gX.exp(dummySecret)),
          ErgoValue.of(g.exp(dummySecret)),
          ErgoValue.of(gX),
          ErgoValue.of(mix.halfMixScriptHash)
        )
        .contract(mix.fullMixScriptContract)
      ...
      val tx = ctx
        .newTxBuilder()
        .addInputs(halfBox, fullBox, feeBox)
