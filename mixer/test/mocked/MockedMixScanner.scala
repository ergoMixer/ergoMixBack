...
class MockedMixScanner extends MockitoSugar {
  ...
  def setTestCases(): Unit = {
    ...
    setReturnValue_followFullMix(
      followFullMixMockedData._1,
      followFullMixMockedData._2,
      followFullMixMockedData._3,
      followFullMixMockedData._4
    )
    setReturnValue_followFullMix(
      backwardRescanFollowedFullMockedData._1,
      backwardRescanFollowedFullMockedData._2,
      backwardRescanFollowedFullMockedData._3,
      backwardRescanFollowedFullMockedData._4
    )
    setReturnValue_followHalfMix(
      backwardRescanFollowedHalfMockedData._1,
      backwardRescanFollowedHalfMockedData._2,
      backwardRescanFollowedHalfMockedData._3,
      backwardRescanFollowedHalfMockedData._4
    )
    setReturnValue_followWithdrawal(
      withdrawWithHopMockedData._1,
      withdrawWithHopMockedData._2,
      withdrawWithHopMockedData._3,
      withdrawWithHopMockedData._4
    )
    setReturnValue_followHopMix(followHopMix._1, followHopMix._2, followHopMix._3, followHopMix._4, followHopMix._5)
    setReturnValue_followHopMix(
      backwardRescanFollowedHopMockedData._1,
      backwardRescanFollowedHopMockedData._2,
      backwardRescanFollowedHopMockedData._3,
      backwardRescanFollowedHopMockedData._4,
      backwardRescanFollowedHopMockedData._5
    )
  }
   ...
   */
  def setReturnValue_followFullMix(
    boxId: String,
    round: Int,
    masterKey: BigInt,
    followedMixes: Seq[FollowedMix]
  ): Unit =
   ...
   * @param followedMixes recovered mix rounds returned by method
   */
  def setReturnValue_followHalfMix(
    boxId: String,
    round: Int,
    masterKey: BigInt,
    followedMixes: Seq[FollowedMix]
   ...
   */
  def setReturnValue_followHopMix(
    boxId: String,
    round: Int,
    masterKey: BigInt,
    followedHops: Seq[FollowedHop],
    followedWithdraw: Option[FollowedWithdraw]
  ): Unit =
   ...
   * @param followedWithdraw optional recovered withdraw returned by method
   */
  def setReturnValue_followWithdrawal(
    boxId: String,
    masterKey: BigInt,
    followedHops: Seq[FollowedHop],
    followedWithdraw: Option[FollowedWithdraw]
