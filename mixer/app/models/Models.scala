...
object StealthModel {
  ...
  case class StealthModel(stealthId: String, sk: String, stealthName: String)

  object Stealth {
    def apply(stealthId: String, sk: String, stealthName: String): StealthModel = {
      StealthModel(stealthId,sk, stealthName)
    }
  }
