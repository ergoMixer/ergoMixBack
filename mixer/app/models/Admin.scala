...
import io.circe.{Json, Encoder, Decoder, parser}
...
object Admin {
  ...
  case class CommissionIncome(timestamp: Long, tokenId: String, ring: Long, numEntered: Int, commission: Long, donation: Long) {
    override def toString: String = this.asJson.toString
  }
