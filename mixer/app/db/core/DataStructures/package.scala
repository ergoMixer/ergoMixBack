...
package object DataStructures {
  ...
  } // Op is op used in where clauses
  ...
  object NotIn extends Op {
    override def toString = "NOT IN"
  }

  object IsNull extends Op {
    override def toString = "IS NULL"
  }

  object IsNotNull extends Op {
    override def toString = "IS NOT NULL"
  }

  object Like extends Op {
    override def toString = "LIKE"
  }

  object RegExp extends Op {
    override def toString = "REGEXP"
  }

  object NotRegExp extends Op {
    override def toString = "NOT REGEXP"
  }

  object NotLike extends Op {
    override def toString = "NOT LIKE"
  }
  ...
  case class IncrOp(increment: Update[_]) extends Op {
    override def toString = Eq + " " + increment.col.colSQLString + " + "
  }
  ...
  object Update {
    def apply[T](update: (Col, T)) = new Update[T](update._1, update._2)
  }
  ...
  object Ordering {
    def apply(ordering: (Col, Boolean)) = new Ordering(ordering._1, ordering._2)
  }
